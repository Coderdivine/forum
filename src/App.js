...
function App() {
 ...
 setNav_show(true)
  ...
  const getGenerals=async()=>{
   await axios.get("https://weiscanforum.herokuapp.com/main-get")
   .then((response)=>{
  ...
  const getTopics=async()=>{
    await axios.get("https://weiscanforum.herokuapp.com/topic-get")
    .then((response)=>{
  ...
  const getComment=async()=>{
    await axios.get("https://weiscanforum.herokuapp.com/comment-get")
    .then((response)=>{
  ...
  const getRe_comment=async()=>{
    await axios.get("https://weiscanforum.herokuapp.com/re-comment-get")
    .then((response)=>{
